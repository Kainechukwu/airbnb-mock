...
import { Corporate, Overview, Individual } from '../components/pages/dashboard'
  ...
  return (
    <div className="h-full w-full">
      <div className="bg-white px-4 sm:px-6 lg:px-8">
        <div className="b-[57px] flex items-center gap-9 ">
          <span className="text-[38px] font-bold text-[#636363]">
            Investment Management
          </span>

          <button className="flex h-[32px] items-center gap-[8px] rounded-[6px] bg-sterling-red-500 px-3 py-[4px] text-white ">
          ...
          {dashboardTabs.map((tab) => (
            ...
            >
              ...
              <div
                className={`${
                  selectedTab == tab
                    ? 'h-[3px] w-full rounded-lg bg-sterling-red-500 shadow-lg'
